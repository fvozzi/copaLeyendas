...
import { createLocality, deleteLocality, getLocalities, updateLocality } from '../lib/api';
import type { Locality, LocalityPayload } from '../types';
...
export function AdminLocalitiesPage() {
  ...
  const openEdit = (locality: Locality) => { setEditing(locality); setForm({ name: locality.name, provinceName: locality.provinceName, active: locality.active }); setError(null); setDialogOpen(true); };
