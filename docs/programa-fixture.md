...
Al abrir un escenario nuevo, todas las zonas y eliminatorias comienzan con **Todas · repartir**. Se toman las sedes del programa existente, pero las canchas anteriores no se convierten en restricciones. Las semifinales y finales se proponen para el **día de finales**, aunque sus horarios anteriores figuren en el día principal; cada cruce se puede cambiar manualmente. Los cuartos conservan el día de finales si ya estaban allí, o se proponen para el día principal. Para fijar una cancha hay que elegirla en el escenario. El reparto prioriza el turno más temprano; si varias canchas están disponibles a la misma hora, elige la que tiene menos partidos asignados ese día.
